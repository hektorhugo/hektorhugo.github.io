...
<head>
  ...
  <script>
        ...
        loadCSS("assets/owl-carousel/owl.carousel.css");
        loadCSS("assets/owl-carousel/owl.theme.css");
        loadCSS("css/wow-alert.css");
  </script>
  <script src="js/modernizr.js" async></script>
  <script type="text/javascript" src="https://code.jquery.com/jquery-2.1.3.min.js" async></script>
  <script src="js/jquery-2.1.1.min.js" async></script>
  <script type="text/javascript" src="js/wow-alert.js" async></script>
 <!-- <script async>
   $.ajax({
    url:'css/default.css',
    type:'get',
...
<!--         <h1><span>Find me on Google Map</span></h1> -->
   ...
   <script src="assets/owl-carousel/owl.carousel.min.js" async></script>
   <script src="js/waypoints.js" async></script>
   <script src="js/jquery.fittext.js" async></script>
   <script src="js/magnific-popup.js" async></script>
